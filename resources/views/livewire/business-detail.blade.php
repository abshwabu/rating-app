                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <span class="text-sm text-gray-500">{{ $business->reviews_count }} reviews</span>
                        </div>
                            ...
                            <div class="space-y-6">
                                @foreach($business->reviews as $review)
                                    <div class="border-b border-gray-100 last:border-0 pb-6 last:pb-0">
                                        ...
                                        @if($review->image)
                                            <div class="mt-4">
                                                <img src="{{ asset('storage/' . $review->image) }}" alt="Review image" class="h-40 w-40 object-cover rounded-lg shadow-sm">
                                            </div>
                                        @endif
                                    </div>
                                @endforeach
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <p class="mt-4 text-gray-500">No reviews yet. Be the first to review this business!</p>
                            </div>
                        @endif
                    </div>
                </div>
